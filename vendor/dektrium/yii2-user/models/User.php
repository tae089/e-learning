...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'level_login'       => Yii::t('user', 'Level Login'),
        ];
    }
    ...
    public function scenarios()
    {
        ...
        return ArrayHelper::merge($scenarios, [
            ...
            'create'   => ['username', 'email', 'password','level_login'],
            'update'   => ['username', 'email', 'password', 'level_login'],
    ...
    public function rules()
    {
        return [
            ...
            // level_login
            'level_loginRequired' => ['level_login', 'required'],
