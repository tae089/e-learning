...
$title1 = Yii::t('user', 'Profile settings');
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <?php $form = \yii\widgets\ActiveForm::begin([
                    ...
                    if ($model->photo) {
                        echo '<img src="'.\Yii::$app->request->BaseUrl.'/'.$model->photo.'" width="90px">&nbsp;&nbsp;&nbsp;';
                        echo Html::a('Delete Photo', ['deleteimg', 'id'=>$model->user_id, 'field'=> 'photo'], ['class'=>'btn btn-danger']).'<p>';
                    }
                    echo "</div>";
                    ?>
